...
namespace taskjo.Controllers
{
    public class AdminFriendsController : Controller
    {
        ...
        // GET: AdminFriends/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: AdminFriends/Create
