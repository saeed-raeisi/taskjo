...
namespace taskjo.Controllers
{
    public class AdminTasksController : Controller
    {
        ...
        {
            ViewBag.phaseId = new SelectList(db.Phases, "phaseId", "phaseTitle");
            return View();
        }
        ...
        public async Task<ActionResult> Create([Bind(Include = "taskId,taskName,taskDesc,taskState,phaseId")] Tasks tasks)
        {
