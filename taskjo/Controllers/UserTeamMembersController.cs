...
{
    public class UserTeamMembersController : Controller
    {
        ...
        {
            //var teamMembers = db.TeamMembers.Include(t => t.UserId == id ).Include(t => t.team);
            //await teamMembers.ToListAsync()
            var teamMembers = db.TeamMembers.Where(t => t.UserId == id).ToList();

            return View(teamMembers);
        }

        // GET: UserTeamMembers/Details/5
